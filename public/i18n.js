window.i18n = (function () {
  ...
  const translations = {
    de: {
      ...
      surchargesHint:
        'Gesetzlich fest ist nur ein "angemessener" Nachtzuschlag (§6 ArbZG), Sonntags-/Feiertagszuschläge hängen vom Tarifvertrag/Arbeitsvertrag ab. Die Standardwerte hier orientieren sich an den steuerfreien Sätzen nach §3b EStG – passe sie an deine tatsächliche Regelung an.',
    ...
    en: {
      ...
      surchargesHint:
        'German law only guarantees an "appropriate" night surcharge (§6 ArbZG); Sunday/holiday surcharges depend on your collective/employment agreement. The defaults here follow the tax-free rates under §3b EStG - adjust them to match your actual arrangement.',
