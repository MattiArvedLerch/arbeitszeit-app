window.i18n = (function () {
  ...
  const translations = {
    de: {
      ...
      surchargesHint:
        'Gesetzlich fest ist nur ein "angemessener" Nachtzuschlag (§6 ArbZG), alle anderen hängen vom Tarifvertrag/Arbeitsvertrag ab. Standardwerte orientieren sich an §3b EStG (Überstunden sind dort nicht erfasst, 25% ist nur ein üblicher Richtwert). Mehrere Zuschläge lassen sich pro Eintrag kombinieren – die Prozentsätze werden dann addiert, nicht multipliziert (z.B. Nacht + Feiertag = beide Sätze zusammen).',
      nightSurcharge: 'Nachtarbeit (%)',
      sundaySurcharge: 'Sonntagsarbeit (%)',
      holidaySurcharge: 'Feiertagsarbeit (%)',
      highHolidaySurcharge: 'Hoher Feiertag (%)',
      overtimeSurcharge: 'Überstunden (%)',
      surchargeType: 'Zuschläge',
      surchargeNone: 'Kein Zuschlag',
      surchargeNight: 'Nachtarbeit',
      surchargeSunday: 'Sonntagsarbeit',
      surchargeHoliday: 'Feiertagsarbeit',
      surchargeHighHoliday: 'Hoher Feiertag',
      surchargeOvertime: 'Überstunden',
    ...
    en: {
      ...
      surchargesHint:
        'German law only guarantees an "appropriate" night surcharge (§6 ArbZG); everything else depends on your collective/employment agreement. Defaults follow §3b EStG (overtime isn\'t covered there, 25% is just a common reference value). Multiple surcharges can be combined per entry - percentages add up rather than compound (e.g. night + holiday = both rates summed).',
      nightSurcharge: 'Night work (%)',
      sundaySurcharge: 'Sunday work (%)',
      holidaySurcharge: 'Holiday work (%)',
      highHolidaySurcharge: 'High holiday (%)',
      overtimeSurcharge: 'Overtime (%)',
      surchargeType: 'Surcharges',
      surchargeNone: 'No surcharge',
      surchargeNight: 'Night work',
      surchargeSunday: 'Sunday work',
      surchargeHoliday: 'Holiday work',
      surchargeHighHoliday: 'High holiday',
      surchargeOvertime: 'Overtime',
